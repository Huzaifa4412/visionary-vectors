  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[24px] text-[20px] sm:leading-[40px] leading-[36px] text-white">Huzaifa | Azeem | Abdullah | Khizar</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Founders of Visionary Vectors</p>
        </div>
