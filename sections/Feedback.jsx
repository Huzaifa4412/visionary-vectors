  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[24px] text-[20px] sm:leading-[40px] leading-[36px] text-white">
            Visionary Vectors
          </h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">
            Leading the AI Digital Revolution
          </p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          “Our mission is to empower startups and enterprises by bridging the gap between cutting-edge AI technology and scalable business solutions that drive real strategic results.”
        </p>
      </motion.div>
