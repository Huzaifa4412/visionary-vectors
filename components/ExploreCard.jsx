  ...
  >
    ...
    { active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <p className="font-normal text-[16px] leading-[20.16px] text-white uppercase">Learn More</p>
        <h2 className="mt-[24px] font-semibold sm:text-[32px] text-[24px] text-white">
          {title}
        </h2>
        {description && (
          <p className="mt-[12px] font-normal sm:text-[16px] text-[14px] leading-relaxed text-secondary-white max-w-[90%]">
            {description}
          </p>
        )}
      </div>
